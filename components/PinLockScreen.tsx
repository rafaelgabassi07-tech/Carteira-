    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[var(--bg-primary)] flex flex-col items-center justify-center p-8 animate-fade-in">
            ...
            <div className="grid grid-cols-3 gap-6">
                ...
                {allowBiometrics ? (
                     <button onClick={handleBiometricAuth} className={`w-16 h-16 rounded-full flex items-center justify-center text-[var(--accent-color)] hover:bg-[var(--bg-tertiary-hover)] transition-all active:scale-95 relative ${isBiometricScanning ? 'ring-2 ring-[var(--accent-color)]/50' : ''}`}>
